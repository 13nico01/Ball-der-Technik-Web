        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          <div className="text-center md:text-left">
            ...
            <div className="space-y-1">
              ...
              >
                balldertechnikhl@gmail.com
              </a>
              <p className="text-white/80">
              Personenkomitee Ball der Technik 2025
              </p>
            </div>
          </div>
          ...
          <div className="text-center space-y-4">
            ...
            <div className="flex justify-center space-x-4">
              ...
              >
                ...
                <span className="font-medium">Ball der Technik</span>
              </a><a
                href="https://www.instagram.com/sv_htlhollabrunn?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center space-x-2 text-white/80 hover:text-header 
                  transition-all duration-300 transform hover:scale-105"
              >
                ...
                <span className="font-medium">SV HTL Hollabrunn</span>
              </a>
            </div>
          </div>
